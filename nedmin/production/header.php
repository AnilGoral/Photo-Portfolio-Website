...
<head>
  ...
  <title>Photography Project Admin Panel</title>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="fotograf.php"><i class="fa fa-camera"></i> Fotoğraflar </a></li>

                <!-- <li><a href="menu.php"><i class="fa fa-list"></i> Menüler </a></li> -->

                <li><a href="kategori.php"><i class="fa fa-folder"></i> Kategoriler </a></li> 
