...
$fotografsor=$db->prepare("SELECT * FROM fotograf where fotograf_id=:id");
$fotografsor->execute(array(
  'id' => $_GET['fotograf_id']
  ));

$fotografcek=$fotografsor->fetch(PDO::FETCH_ASSOC);
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kategori Seç<span class="required">*</span>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="first-name" name="fotograf_ad" value="<?php echo $fotografcek['fotograf_ad'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <textarea  class="ckeditor" id="editor1" name="fotograf_detay"><?php echo $fotografcek['fotograf_detay']; ?></textarea>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Fotoğraf Keyword <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="fotograf_keyword" value="<?php echo $fotografcek['fotograf_keyword'] ?>"  class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <select id="heard" class="form-control" name="fotograf_durum" required>
                  ...
                  <option value="1" <?php echo $fotografcek['fotograf_durum'] == '1' ? 'selected=""' : ''; ?>>Aktif</option>



                  <option value="0" <?php if ($fotografcek['fotograf_durum']==0) { echo 'selected=""'; } ?>>Pasif</option>
             ...
             <input type="hidden" name="fotograf_id" value="<?php echo $fotografcek['fotograf_id'] ?>"> 


             <div class="ln_solid"></div>
             <div class="form-group">
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="fotografduzenle" class="btn btn-success">Güncelle</button>
              </div>
            </div>
